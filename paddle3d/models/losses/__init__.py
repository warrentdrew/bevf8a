...
from .iou_loss import IOULoss, GIoULoss, RDIoULoss
...
from .weight_loss import (WeightedCrossEntropyLoss, WeightedSmoothL1Loss,
                          WeightedSigmoidLoss, WeightedSmoothL1LossIDG, 
                          WeightedSoftmaxClassificationLossIDG)
from .cross_entropy_loss import CrossEntropyLoss, CrossEntropyLossIDG
