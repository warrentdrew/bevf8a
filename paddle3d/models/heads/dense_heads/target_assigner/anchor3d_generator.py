...
class Anchor3DRangeGenerator(object):
    ...
    def __init__(self,
        ...
        self.out_downsample_size = out_downsample_size
    ...
    def grid_anchors(self, featmap_sizes):
        ...
        if isinstance(featmap_sizes[0], np.ndarray):
            featmap_sizes = [(featmap_size // self.out_downsample_size).astype(np.int) for featmap_size in featmap_sizes]
