...
class CamToBEVTransformer(nn.Layer):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
                ...
                bev_w=_bev_w,
                **kwargs):
        super(CamToBEVTransformer, self).__init__()
        ...
        print("cam2bev: self.bev_h = {}, self.bev_w = {}, self.pc_range = {} ".format(self.bev_h, self.bev_w, self.pc_range))
    ...
    def forward(self, mlvl_feats, img_metas, prev_bev=None,  only_bev=True):
        ...
        #print("mlvl_feats.len: ", len(mlvl_feats))
        #print("mlvl_feats[0].size: ", mlvl_feats[0].size())
        ...
        #print("self.bev_h={}, self.bev_w={} ".format(self.bev_h, self.bev_w))
        ...
        #bev_embed = bev_embed.view(bs, self.bev_h, self.bev_w, -1).permute(0,3,1,2)
