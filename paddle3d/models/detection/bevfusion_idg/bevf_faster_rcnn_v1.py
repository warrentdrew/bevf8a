...
class BEVFFasterRCNNV1(MVXFasterRCNN):
    ...
    def extract_feat(self, points, img, img_metas, gt_bboxes_3d=None, gt_labels_3d=None, lidar_aug_matrix=None):
        ...
        # return dict(img_feats=img_feats) # add
        ...
        # return dict(img_feats=img_feats, pts_feats = pts_feats) # add
    ...
    def forward_train(self,
        ...
        #=========================
        # losses = img_feats[0].sum()
        # losses = dict()
        # losses['loss_test1'] = img_feats[0].sum() + pts_feats[0].sum()
        # return losses
        # ========================

        

        # losses = img_feats.sum()
