...
#     local="/mnt/zhuyipin/afs_mount_lidarrcnn/ADU_KM_Data"
...
# afs_local_mount_point_02="/mnt/zhuyipin/afs_mount_lidarrcnn/lable-data"
...
# local="/mnt/zhuyipin/afs_mount_lidarrcnn/heye"
...
# afs_local_mount_point_03="/mnt/zhuyipin/afs_mount_lidarrcnn/ADT90p"
...
# afs_local_mount_point_03="/mnt/zhuyipin/afs_mount_lidarrcnn/ADT-perception-train-data/"
# mount_afs_data ${fs_name} ${username} ${password} ${afs_local_mount_point_03} ${afs_remote_mount_point_03}
...
afs_local_mount_point_03="/mnt/zhuyipin/afs_mount_lidarrcnn/atd-vis-rawdata"
mount_afs_data ${fs_name} ${username} ${password} ${afs_local_mount_point_03} ${afs_remote_mount_point_03}