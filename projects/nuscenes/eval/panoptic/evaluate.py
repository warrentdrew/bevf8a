...
class NuScenesPanopticEval:
    ...
    def evaluate_segmentation(self) -> Dict[str, Any]:
        ...
        psrq = self.evaluator['segmentation'].getPQ()
        mean_pq, mean_sq, mean_rq, class_all_pq, class_all_sq, class_all_rq = psrq['PQ'], psrq['SQ'], psrq['RQ'], \
                                                    psrq['pq_all'], psrq['sq_all'], psrq['rq_all']
