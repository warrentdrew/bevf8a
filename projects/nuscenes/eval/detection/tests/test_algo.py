...
from projects.nuscenes.eval.detection.algo_score import accumulate, calc_ap, calc_tp
    ...
    def test_nd_score(self):
        ...
        for class_name in self.cfg.class_names:
            ...
            for dist_th in self.cfg.dist_ths:
                mdl.set(class_name, dist_th, accumulate('test', gt, pred, None, class_name, None, center_distance, None))
...
def get_metric_data(gts: Dict[str, List[Dict]],
        ...
        metric_data = accumulate('test', gt_eval_boxes, pred_eval_boxes, class_name=detection_name,
                                accumulate_dict=None, cfg=None, 
                                 distance=center_distance, pred_taken=dist_th)
        return metric_data
